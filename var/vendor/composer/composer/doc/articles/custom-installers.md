...
```json
{
    "name": "phpdocumentor/templates-responsive",
    "type": "phpdocumentor-templates",
    "require": {
...
```json
{
    "name": "phpdocumentor/templates-installer-plugin",
...
class TemplateInstaller extends LibraryInstaller
{
    ...
    public function getInstallPath(PackageInterface $package)
    {
        ...
        if ('phpdocumentor/templates-' !== $prefix) {
            throw new \InvalidArgumentException(
                'Unable to install templates, phpdocumentor templates '
    ...
    {
        return 'phpdocumentor-templates' === $packageType;
    }
}
```
