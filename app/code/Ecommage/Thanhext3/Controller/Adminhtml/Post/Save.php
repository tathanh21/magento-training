...
use Ecommage\ThanhEx2\Controller\Adminhtml\Post\PostDataProcessor;
...
class Save extends \Magento\Backend\App\Action implements HttpPostActionInterface
{
    ...
    public function __construct(
        ...
        \Ecommage\Thanhext3\Model\PostFactory $postFactory = null,
        \Magento\Cms\Api\PageRepositoryInterface $pageRepository = null
    ) {
        $this->dataProcessor = $dataProcessor;
        $this->dataPersistor = $dataPersistor;
        $this->postFactory = $postFactory ?: ObjectManager::getInstance()->get(\Ecommage\Thanhext3\Model\PostFactory::class);
...
//                return $this->processResultRedirect($model, $resultRedirect, $data);
            ...
            return $resultRedirect->setPath('*/*/', ['blog_id' => $this->getRequest()->getParam('blog_id')]);
        }
